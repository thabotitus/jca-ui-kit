...
(function (a) {
  ...
  a.extend(!0, d.defaults, {
    dom:
      "<'row pb-40'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row pt-40'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
    renderer: "bootstrap",
  });
  a.extend(d.ext.classes, {
    ...
    sPageButton: "jca-pagination__item",
  });
  d.ext.renderer.pageButton.bootstrap = function (b, l, v, w, m, r) {
          ...
          if (a.isArray(f)) u(c, f);
            ...
            switch (f) {
              ...
              case "last":
                ...
                break;
              default:
                (g = f + 1), (h = m === f ? "jca-pagination--current" : "");
            }
            if (g) {
              var p = a("<li>", {
    ...
    u(a(l).empty().html('<ul class="jca-pagination"/>').children("ul"), w);
    p !== e &&
      a(l)
        .find("[data-dt-idx=" + p + "]")
        .trigger("focus");
